                        ...
                        <ul class="nav navbar-nav">
							...
							<li """),_display_(/*58.13*/if(pagename == "Login")/*58.36*/{_display_(Seq[Any](format.raw/*58.37*/("""class="active"""")))}),format.raw/*58.52*/(""">
								"""),_display_(/*59.10*/if((user != null) && ("LandLord".equals(user.getRole())))/*59.67*/ {_display_(Seq[Any](format.raw/*59.69*/("""
									"""),format.raw/*60.10*/("""<li """),_display_(/*60.15*/if(pagename == "Landlords")/*60.42*/ {_display_(Seq[Any](format.raw/*60.44*/("""class="active"""")))}),format.raw/*60.59*/("""><a href=""""),_display_(/*60.70*/routes/*60.76*/.HomeController.landlord()),format.raw/*60.102*/("""">View Landlords</a></li>
