                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="nav navbar-nav">
							...
							"""),_display_(/*130.9*/if((user != null) && ("admin".equals(user.getRole())))/*130.63*/ {_display_(Seq[Any](format.raw/*130.65*/("""
								"""),format.raw/*131.9*/("""<li """),_display_(/*131.14*/if(pagename == "Landlords")/*131.41*/ {_display_(Seq[Any](format.raw/*131.43*/("""class="active"""")))}),format.raw/*131.58*/("""><a href=""""),_display_(/*131.69*/routes/*131.75*/.HomeController.landlord()),format.raw/*131.101*/("""">View Landlords</a></li>
							""")))}),format.raw/*132.9*/("""
