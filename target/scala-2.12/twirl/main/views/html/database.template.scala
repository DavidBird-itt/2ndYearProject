...
<h1>Idea 2</h1>
    ...
    <table class="table table-bordered table-hover table-condensed">
        <tbody>
            """),_display_(/*121.14*/for(i<-aList) yield /*121.27*/ {_display_(Seq[Any](format.raw/*121.29*/("""
                    """),_display_(/*122.22*/if(env.resource("public/images/projectImages/" + i.getId + "thumb.jpg").isDefined)/*122.104*/ {_display_(Seq[Any](format.raw/*122.106*/("""
                    """),format.raw/*123.21*/("""<td><img src="/assets/images/projectImages/"""),_display_(/*123.65*/(i.getId + "thumb.jpg")),format.raw/*123.88*/(""""/></td>
                    """)))}/*124.23*/else/*124.28*/{_display_(Seq[Any](format.raw/*124.29*/("""
                    """),format.raw/*125.21*/("""<td><img src="/assets/images/projectImages/noImage.jpg"/></td>
                    """)))}),format.raw/*126.22*/("""
                    """),format.raw/*127.21*/("""<td><i class= "fas fa-bed"></i> """),_display_(/*127.54*/i/*127.55*/.getNumBeds),format.raw/*127.66*/("""</td>
                    <td><i class= "fas fa-toilet"></i> """),_display_(/*128.57*/i/*128.58*/.getNumBaths),format.raw/*128.70*/("""</td>
                    <td>&euro; """),_display_(/*129.33*/("%.2f".format(i.getPrice))),format.raw/*129.60*/("""</td>
        </tbody>
    </table>        

    """),_display_(/*133.6*/if((user != null) && ("admin".equals(user.getRole()) || "landlord".equals(user.getRole())))/*133.97*/ {_display_(Seq[Any](format.raw/*133.99*/("""
    """),format.raw/*134.5*/("""<p>
        <a href=""""),_display_(/*135.19*/routes/*135.25*/.HomeController.addHouse()),format.raw/*135.51*/("""">
