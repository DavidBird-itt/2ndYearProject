              ...
              """),format.raw/*65.15*/("""</td>
                  <td class="desc">
                      ...
                      <i class="fas fa-leaf"></i>"""),_display_(/*70.51*/property/*70.59*/.getStock),format.raw/*70.68*/("""&nbsp;
                          ...
                          &nbsp;
                          <a href=""""),_display_(/*73.37*/routes/*73.43*/.HomeController.updateProperty(property.getId)),format.raw/*73.89*/(""""><i class="fas fa-edit"></i></a>
                          &nbsp;
                          <a href=""""),_display_(/*75.37*/routes/*75.43*/.HomeController.deleteProperty(property.getId)),format.raw/*75.89*/("""" onclick="return confirmDel();"><i class="fas fa-trash"></i></a>
                      
                  </td>
              </a>
          </tr>
      """)))}),format.raw/*80.8*/("""
  """),format.raw/*81.3*/("""</table>
""")))}),format.raw/*82.2*/("""
""")))}))
      }
    }
