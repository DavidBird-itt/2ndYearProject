...
class Routes(
  ...
  // @LINE:15
  private[this] lazy val controllers_HomeController_onsale4_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("onsale")))
  )
  private[this] lazy val controllers_HomeController_onsale4_invoker = createInvoker(
    HomeController_0.onsale,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "onsale",
  ...
  // @LINE:21
  private[this] lazy val controllers_HomeController_CRUD7_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("CRUD")))
  )
  private[this] lazy val controllers_HomeController_CRUD7_invoker = createInvoker(
    HomeController_0.CRUD,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "CRUD",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:15
    case controllers_HomeController_onsale4_route(params@_) =>
      call { 
        controllers_HomeController_onsale4_invoker.call(HomeController_0.onsale)
      }
  
    // @LINE:17
    case controllers_HomeController_about5_route(params@_) =>
      call { 
        controllers_HomeController_about5_invoker.call(HomeController_0.about)
      }
  
    // @LINE:19
    case controllers_HomeController_payment6_route(params@_) =>
      call { 
        controllers_HomeController_payment6_invoker.call(HomeController_0.payment)
      }
  
    // @LINE:21
    case controllers_HomeController_CRUD7_route(params@_) =>
      call { 
        controllers_HomeController_CRUD7_invoker.call(HomeController_0.CRUD)
      }
  }
}
