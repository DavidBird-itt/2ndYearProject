...
class Routes(
  ...
  // @LINE:32
  private[this] lazy val controllers_HomeController_searchDB11_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("searchQuery")))
  )
  private[this] lazy val controllers_HomeController_searchDB11_invoker = createInvoker(
  ...
  // @LINE:34
  private[this] lazy val controllers_HomeController_addHouse12_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addHouse")))
  )
  private[this] lazy val controllers_HomeController_addHouse12_invoker = createInvoker(
  ...
  // @LINE:35
  private[this] lazy val controllers_HomeController_addHouseSubmit13_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addHouseSubmit")))
  )
  private[this] lazy val controllers_HomeController_addHouseSubmit13_invoker = createInvoker(
  ...
  // @LINE:36
  private[this] lazy val controllers_HomeController_deleteHouse14_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deleteHouse/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_deleteHouse14_invoker = createInvoker(
  ...
  // @LINE:37
  private[this] lazy val controllers_HomeController_updateHouse15_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateHouse/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_updateHouse15_invoker = createInvoker(
  ...
  // @LINE:39
  private[this] lazy val controllers_HomeController_addApartment16_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addApartment")))
  )
  private[this] lazy val controllers_HomeController_addApartment16_invoker = createInvoker(
  ...
  // @LINE:40
  private[this] lazy val controllers_HomeController_addApartmentSubmit17_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addApartmentSubmit")))
  )
  private[this] lazy val controllers_HomeController_addApartmentSubmit17_invoker = createInvoker(
  ...
  // @LINE:41
  private[this] lazy val controllers_HomeController_deleteApartment18_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deleteApartment/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_deleteApartment18_invoker = createInvoker(
  ...
  // @LINE:42
  private[this] lazy val controllers_HomeController_updateApartment19_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateApartment/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_updateApartment19_invoker = createInvoker(
  ...
  // @LINE:44
  private[this] lazy val controllers_HomeController_viewUsers20_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("viewUsers")))
  )
  private[this] lazy val controllers_HomeController_viewUsers20_invoker = createInvoker(
  ...
  // @LINE:45
  private[this] lazy val controllers_HomeController_addLandlord21_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addLandlord")))
  )
  private[this] lazy val controllers_HomeController_addLandlord21_invoker = createInvoker(
  ...
  // @LINE:46
  private[this] lazy val controllers_HomeController_addLandlordSubmit22_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addLandlordSubmit")))
  )
  private[this] lazy val controllers_HomeController_addLandlordSubmit22_invoker = createInvoker(
  ...
  // @LINE:47
  private[this] lazy val controllers_HomeController_updateLandlord23_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateLandlord/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_updateLandlord23_invoker = createInvoker(
  ...
  // @LINE:48
  private[this] lazy val controllers_HomeController_deleteLandlord24_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deleteLandlord/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_deleteLandlord24_invoker = createInvoker(
  ...
  // @LINE:50
  private[this] lazy val controllers_HomeController_createAccount25_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("createAccount")))
  )
  private[this] lazy val controllers_HomeController_createAccount25_invoker = createInvoker(
  ...
  // @LINE:51
  private[this] lazy val controllers_HomeController_addMember26_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addMember")))
  )
  private[this] lazy val controllers_HomeController_addMember26_invoker = createInvoker(
  ...
  // @LINE:52
  private[this] lazy val controllers_HomeController_addMemberSubmit27_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addMemberSubmit")))
  )
  private[this] lazy val controllers_HomeController_addMemberSubmit27_invoker = createInvoker(
  ...
  // @LINE:53
  private[this] lazy val controllers_HomeController_updateMember28_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateMember/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_updateMember28_invoker = createInvoker(
  ...
  // @LINE:54
  private[this] lazy val controllers_HomeController_deleteMember29_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deleteMember/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_deleteMember29_invoker = createInvoker(
  ...
  // @LINE:56
  private[this] lazy val controllers_HomeController_addAdmin30_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addAdmin")))
  )
  private[this] lazy val controllers_HomeController_addAdmin30_invoker = createInvoker(
  ...
  // @LINE:57
  private[this] lazy val controllers_HomeController_addAdminSubmit31_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addAdminSubmit")))
  )
  private[this] lazy val controllers_HomeController_addAdminSubmit31_invoker = createInvoker(
  ...
  // @LINE:62
  private[this] lazy val controllers_RentCtrl_viewRent34_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("viewRent")))
  )
  private[this] lazy val controllers_RentCtrl_viewRent34_invoker = createInvoker(
    RentCtrl_4.viewRent(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
  ...
  // @LINE:63
  private[this] lazy val controllers_RentCtrl_setupRent35_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("setupRent")))
  )
  private[this] lazy val controllers_RentCtrl_setupRent35_invoker = createInvoker(
  ...
  // @LINE:65
  private[this] lazy val controllers_ShoppingCtrl_showBasket36_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("showBasket")))
  )
  private[this] lazy val controllers_ShoppingCtrl_showBasket36_invoker = createInvoker(
  ...
  // @LINE:66
  private[this] lazy val controllers_ShoppingCtrl_addToBasket37_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("addToBasket/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_ShoppingCtrl_addToBasket37_invoker = createInvoker(
  ...
  // @LINE:67
  private[this] lazy val controllers_ShoppingCtrl_removeOne38_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("removeOne/"), DynamicPart("itemId", """[^/]+""",true)))
  )
  private[this] lazy val controllers_ShoppingCtrl_removeOne38_invoker = createInvoker(
  ...
  // @LINE:68
  private[this] lazy val controllers_ShoppingCtrl_emptyBasket39_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("emptyBasket")))
  )
  private[this] lazy val controllers_ShoppingCtrl_emptyBasket39_invoker = createInvoker(
  ...
  // @LINE:69
  private[this] lazy val controllers_ShoppingCtrl_placeOrder40_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("placeOrder")))
  )
  private[this] lazy val controllers_ShoppingCtrl_placeOrder40_invoker = createInvoker(
  ...
  // @LINE:70
  private[this] lazy val controllers_ShoppingCtrl_viewOrder41_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("viewOrder/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_ShoppingCtrl_viewOrder41_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:32
    case controllers_HomeController_searchDB11_route(params@_) =>
      call(params.fromQuery[Integer]("min", Some(0)), params.fromQuery[Integer]("max", Some(0))) { (min, max) =>
        controllers_HomeController_searchDB11_invoker.call(HomeController_1.searchDB(min, max))
      }
  
    // @LINE:34
    case controllers_HomeController_addHouse12_route(params@_) =>
      call { 
        controllers_HomeController_addHouse12_invoker.call(HomeController_1.addHouse)
      }
  
    // @LINE:35
    case controllers_HomeController_addHouseSubmit13_route(params@_) =>
      call { 
        controllers_HomeController_addHouseSubmit13_invoker.call(HomeController_1.addHouseSubmit)
      }
  
    // @LINE:36
    case controllers_HomeController_deleteHouse14_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_deleteHouse14_invoker.call(HomeController_1.deleteHouse(id))
      }
  
    // @LINE:37
    case controllers_HomeController_updateHouse15_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_updateHouse15_invoker.call(HomeController_1.updateHouse(id))
      }
  
    // @LINE:39
    case controllers_HomeController_addApartment16_route(params@_) =>
      call { 
        controllers_HomeController_addApartment16_invoker.call(HomeController_1.addApartment)
      }
  
    // @LINE:40
    case controllers_HomeController_addApartmentSubmit17_route(params@_) =>
      call { 
        controllers_HomeController_addApartmentSubmit17_invoker.call(HomeController_1.addApartmentSubmit)
      }
  
    // @LINE:41
    case controllers_HomeController_deleteApartment18_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_deleteApartment18_invoker.call(HomeController_1.deleteApartment(id))
      }
  
    // @LINE:42
    case controllers_HomeController_updateApartment19_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_updateApartment19_invoker.call(HomeController_1.updateApartment(id))
      }
  
    // @LINE:44
    case controllers_HomeController_viewUsers20_route(params@_) =>
      call { 
        controllers_HomeController_viewUsers20_invoker.call(HomeController_1.viewUsers)
      }
  
    // @LINE:45
    case controllers_HomeController_addLandlord21_route(params@_) =>
      call { 
        controllers_HomeController_addLandlord21_invoker.call(HomeController_1.addLandlord)
      }
  
    // @LINE:46
    case controllers_HomeController_addLandlordSubmit22_route(params@_) =>
      call { 
        controllers_HomeController_addLandlordSubmit22_invoker.call(HomeController_1.addLandlordSubmit)
      }
  
    // @LINE:47
    case controllers_HomeController_updateLandlord23_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_HomeController_updateLandlord23_invoker.call(HomeController_1.updateLandlord(id))
      }
  
    // @LINE:48
    case controllers_HomeController_deleteLandlord24_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_HomeController_deleteLandlord24_invoker.call(HomeController_1.deleteLandlord(id))
      }
  
    // @LINE:50
    case controllers_HomeController_createAccount25_route(params@_) =>
      call { 
        controllers_HomeController_createAccount25_invoker.call(HomeController_1.createAccount)
      }
  
    // @LINE:51
    case controllers_HomeController_addMember26_route(params@_) =>
      call { 
        controllers_HomeController_addMember26_invoker.call(HomeController_1.addMember)
      }
  
    // @LINE:52
    case controllers_HomeController_addMemberSubmit27_route(params@_) =>
      call { 
        controllers_HomeController_addMemberSubmit27_invoker.call(HomeController_1.addMemberSubmit)
      }
  
    // @LINE:53
    case controllers_HomeController_updateMember28_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_HomeController_updateMember28_invoker.call(HomeController_1.updateMember(id))
      }
  
    // @LINE:54
    case controllers_HomeController_deleteMember29_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_HomeController_deleteMember29_invoker.call(HomeController_1.deleteMember(id))
      }
  
    // @LINE:56
    case controllers_HomeController_addAdmin30_route(params@_) =>
      call { 
        controllers_HomeController_addAdmin30_invoker.call(HomeController_1.addAdmin)
      }
  
    // @LINE:57
    case controllers_HomeController_addAdminSubmit31_route(params@_) =>
      call { 
        controllers_HomeController_addAdminSubmit31_invoker.call(HomeController_1.addAdminSubmit)
      }
  
    // @LINE:58
    case controllers_HomeController_updateAdmin32_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_HomeController_updateAdmin32_invoker.call(HomeController_1.updateAdmin(id))
      }
  
    // @LINE:59
    case controllers_HomeController_deleteAdmin33_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_HomeController_deleteAdmin33_invoker.call(HomeController_1.deleteAdmin(id))
      }
  
    // @LINE:62
    case controllers_RentCtrl_viewRent34_route(params@_) =>
      call { 
        controllers_RentCtrl_viewRent34_invoker.call(RentCtrl_4.viewRent())
      }
  
    // @LINE:63
    case controllers_RentCtrl_setupRent35_route(params@_) =>
      call(params.fromQuery[String]("id", None)) { (id) =>
        controllers_RentCtrl_setupRent35_invoker.call(RentCtrl_4.setupRent(id))
      }
  
    // @LINE:65
    case controllers_ShoppingCtrl_showBasket36_route(params@_) =>
      call { 
        controllers_ShoppingCtrl_showBasket36_invoker.call(ShoppingCtrl_3.showBasket())
      }
  
    // @LINE:66
    case controllers_ShoppingCtrl_addToBasket37_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_ShoppingCtrl_addToBasket37_invoker.call(ShoppingCtrl_3.addToBasket(id))
      }
  
    // @LINE:67
    case controllers_ShoppingCtrl_removeOne38_route(params@_) =>
      call(params.fromPath[Long]("itemId", None)) { (itemId) =>
        controllers_ShoppingCtrl_removeOne38_invoker.call(ShoppingCtrl_3.removeOne(itemId))
      }
  
    // @LINE:68
    case controllers_ShoppingCtrl_emptyBasket39_route(params@_) =>
      call { 
        controllers_ShoppingCtrl_emptyBasket39_invoker.call(ShoppingCtrl_3.emptyBasket())
      }
  
    // @LINE:69
    case controllers_ShoppingCtrl_placeOrder40_route(params@_) =>
      call { 
        controllers_ShoppingCtrl_placeOrder40_invoker.call(ShoppingCtrl_3.placeOrder())
      }
  
    // @LINE:70
    case controllers_ShoppingCtrl_viewOrder41_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_ShoppingCtrl_viewOrder41_invoker.call(ShoppingCtrl_3.viewOrder(id))
      }
  }
}
